...
#pragma GCC diagnostic ignored  "-Wdeprecated-declarations"
    http.begin(url);
#pragma GCC diagnostic pop
    return handleUpdate(http, currentVersion, false, "", HttpGet);
}
...
#pragma GCC diagnostic ignored  "-Wdeprecated-declarations"
    http.begin(url, httpsFingerprint);
#pragma GCC diagnostic pop
    return handleUpdate(http, currentVersion, true, "", HttpGet);
}
...
HTTPUpdateResult ESP8266HTTPUpdate::update(WiFiClient& client, const String& host, uint16_t port, const String& uri, const String& jsonString,
        const String& currentVersion)
{
    HTTPClient http;
    http.begin(client, host, port, uri);
    return handleUpdate(http, currentVersion, false, jsonString, HttpPost);
}
...
{
	return handleUpdate(http, currentVersion, spiffs, "", HttpGet);
}
 
HTTPUpdateResult ESP8266HTTPUpdate::handleUpdate(HTTPClient& http, const String& currentVersion, bool spiffs, const String& jsonString, HttpFunction hf)
{

...
#define DEBUG_HTTP_UPDATE(...) do { Serial.printf(__VA_ARGS__); } while(0)
#endif
...
public:
    ...
    t_httpUpdate_return update(WiFiClient& client, const String& host, uint16_t port, const String& uri = "/",
                               const String& jsonString = "{}", const String& currentVersion = "");
...
protected:
    ...
    t_httpUpdate_return handleUpdate(HTTPClient& http, const String& currentVersion, bool spiffs = false, const String& jsonString = "{}", HttpFunction hf = HttpGet);
